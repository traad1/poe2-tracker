...
from pages_ import market, watchlist, pnl

st.set_page_config(page_title="PoE 2 Trade Tracker", page_icon=":coin:", layout="wide")

st.title("Path of Exile 2 — Trade & Economy")
st.caption("Live market • Flip watchlist • Inflation hedges • PnL")

league = market.league_selector()

tab_market, tab_watch, tab_pnl = st.tabs(["Market", "Watchlist", "PnL"])
